...
<body>
    ...
    <form action="{{route('product.store')}}" method="post" enctype="multipart/form-data">
        ...
        <input type="text" name="name" id="name"placeholder="Product_Name" value="{{old('name')}}">
        @if ($errors->has('name'))
        ...
        <input type="text" name="category_id" id="category_id"placeholder="Category_Id" value="{{old('category_id')}}">
